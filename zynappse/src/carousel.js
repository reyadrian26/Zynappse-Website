            ...
            <Col md={6} className="text-left   ">
              <Carousel.Caption className="animatedParent animateOnce text-left">
                ...
                <Col md={12}  className="text-left animated fadeInUp delay-750" >
                  <a href="https://play.google.com/store/apps/details?id=com.zynappse.rwmanila&hl=en"  target="_blank" ><img style={{paddingRight: "32px"}} src={images.android2} target="_blank" height="50" /></a>
...
everywhere you go. Get Alaska Aces news, player profiles, schedules and more.
                ...
                <Col md={12}  className="text-left animated fadeInUp delay-750" >
                    ...
                    <a href="https://play.google.com/store/apps/details?id=ph.com.alaskaaces&hl=en"  target="_blank"><img  style={{paddingRight: "32px"}} src={images.android2} target="_blank" height="50" /></a>
              ...
              <Carousel.Caption className="animatedParent animateOnce">
                <h3 className="text-left">My Blood</h3>
                  ...
                  <Col md={12}  className="text-left animated fadeInUp delay-750" >
                      ...
                      <a href="https://play.google.com/store/apps/details?id=com.mybloodprofile.myblood&hl=en"  target="_blank"><img style={{paddingRight: "32px"}} src={images.android2} target="_blank" height="50" /></a>
            ...
            <Col md={6} className="text-left">
              <Carousel.Caption className="animatedParent animateOnce">
                ...
                <Col md={12}  className="text-left animated fadeInUp delay-750" >
                    ...
                    <a href="https://play.google.com/store/apps/details?id=com.unfold.unfold&hl=en"  target="_blank"><img style={{paddingRight: "32px"}} src={images.android2} target="_blank" height="50" /></a>
  ...
  <Col md={12} className="text-center">
    <a href="http://www.zynappse.com/Zynappse_ProfilePortfolio.pdf" download="Zynappse_ProfilePortfolio" target="_blank" className="btn-custom"  style={{color: "#fff"}}>Download our Portfolio</a>
