    ...
    return (
      <div className="container margin-section ">
        ...
        <Col md={12} className="text-center animatedParent animateOnce">
          <img className="animated fadeInLeft" src={"/static/app-solution.svg"} alt="appsolution" height={200}/>
        ...
        <Col md={12} className="text-center animatedParent animateOnce">
          <img className="animated fadeInLeft delay-250" src={"/static/web-solution.svg"} alt="websolution" height={200}/>
        ...
        <Col md={12} className="text-center animatedParent animateOnce">
          <img className="animated fadeInLeft " src={"/static/cloud2.svg"} alt="cloud" height={200}/>
        ...
        <Col md={12} className="text-center animatedParent animateOnce">
          <img className="animated fadeInLeft" src={"/static/ai.svg"} alt="artificial-intelligence" height={200}/>
        ...
        <Col md={12} className="text-center animatedParent animateOnce">
          <img className="animated fadeInLeft " src={"/static/ar.svg"} alt="augmented-reality" height={200}/>
