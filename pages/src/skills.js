    ...
    return (
      <div className="container margin-section  animatedParent animateOnce" id="skills">
        ...
        <Col md={4} className="text-center   animatedParent animateOnce">
          <img width={200} src={"/static/android.gif"} alt="android" className="animated growIn"/>
          <h2 className="gradient animated growIn">99%</h2>

          <p className="animated growIn">Android</p>
        </Col>
        <Col md={4} className="text-center  animatedParent animateOnce">
          <img height={200} src={"/static/apple.gif"} alt="apple" className="animated growIn"/>
          <h2 className="gradient animated growIn">99%</h2>
        ...
        <Col md={4} className="text-center  animatedParent animateOnce">
          <img width={200} src={"/static/web.gif"} alt="web" className="animated growIn"/>
          <h2 className="gradient animated growIn">99%</h2>
